...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://zedule.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Zedule";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@zedule.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Zedule";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Zedule";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Zedule";
export const EMAIL_FROM_NAME = process.env.EMAIL_FROM_NAME || APP_NAME;

// This is the URL from which all Zedule Links and their assets are served.
// Use website URL to make links shorter
...
// Zedule is always self-hosted and not tied to specific domains
export const IS_CALCOM = false;

export const CONSOLE_URL = WEBAPP_URL;
const WEBAPP_HOSTNAME = new URL(WEBAPP_URL).hostname;
// Zedule is always self-hosted
...
// All features available in Zedule
...
export const DESKTOP_APP_LINK = `${WEBSITE_URL}/download`;
export const JOIN_COMMUNITY = `${WEBSITE_URL}/community`;
export const POWERED_BY_URL = `${WEBSITE_URL}/booking`;
export const DOCS_URL = `${WEBSITE_URL}/docs`;
export const DEVELOPER_DOCS = `${WEBSITE_URL}/docs/developer`;
...
export const CALCOM_PRIVATE_API_ROUTE = process.env.CALCOM_PRIVATE_API_ROUTE || `${WEBAPP_URL}/api`;
